  ...
  const fetchCounts = async () => {
    try {
      const [
        ...
        axios.get(`${process.env.REACT_APP_API_BASE_URL}/rents/count_rented_request`),
        axios.get(`${process.env.REACT_APP_API_BASE_URL}/rents/count_pending`),
        axios.get(`${process.env.REACT_APP_API_BASE_URL}/rents/count_rented`),
        axios.get(`${process.env.REACT_APP_API_BASE_URL}/rents/count_returned`),
        axios.get(`${process.env.REACT_APP_API_BASE_URL}/rents/count_rejected`),
        axios.get(`${process.env.REACT_APP_API_BASE_URL}/items/count/itemsCount`),
        axios.get(`${process.env.REACT_APP_API_BASE_URL}/item_types/itemTypesList`), // Correct endpoint
      ]);
  ...
  const fetchItemsByType = async (itemTypeId) => {
    try {
      const response = await axios.get(
        `${process.env.REACT_APP_API_BASE_URL}/item_types/byId/${itemTypeId}`
      );
